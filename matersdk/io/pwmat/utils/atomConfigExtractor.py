...
class AtomConfigStrExtractor(AtomConfigExtractorBase):
    ...
    def get_magmoms(self):
        ...
        try:
            ...
            raise AttributeError("AtomConfigStrExtractor: No magmoms info in MOVEMENT.")
    ...
    def get_eatoms(self):
        ...
        try:
            ...
            raise AttributeError("AtomConfigExtractorError: No atomic energy info in MOVMENT.")
    ...
    def get_virial(self):
        ...
        for tmp_idx in [aim_idx+1, aim_idx+2, aim_idx+3]:
            ...
            if len(tmp_aim_row_lst) == 0:
                raise AttributeError("AtomConfigStrExtractorError: No virial info in MOVEMENT.");
