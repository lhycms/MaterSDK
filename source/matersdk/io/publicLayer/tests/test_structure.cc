...
TEST_F(StructureTest, init_array) {
    matersdk::Structure<double> structure(num_atoms, basis_vectors, atomic_numbers, frac_coords, true);
    structure.show();
}


TEST_F(StructureTest, calc_cart_coords_array) {
