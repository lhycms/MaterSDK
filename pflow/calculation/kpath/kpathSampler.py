...
class KpathSampler(KPathSetyawanCurtarolo):
    ...
    def __init__(self,
        ...
        ### Note: 1. 必须先得到 self.kpoints，再得到 self.kpaths (利用 self.points 的坐标处理二维材料)
        ### Note: 2. 字典：{"高对称点": "分数坐标", ...}, `分数坐标 / density`之前，需要乘以倒易点阵真正的长度
    ...
    def _get_kpaths(self):
        ...
        return_kpaths_lst = [tmp_kpath for tmp_kpath in return_kpaths_lst if (len(tmp_kpath) > 1)]
        
        return return_kpaths_lst